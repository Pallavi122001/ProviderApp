...
import ExploreCollegesCards from '../Property/ExploreCollegesCards';
...
export default function ExploreColleges() {
  ...
  return (
    <View style={{ backgroundColor: 'white',flex:1 }}>
      ...
      <Text style={styles.heading}>Colleges</Text>
      <ExploreCollegesCards />
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  contanier:{
    ...
    alignItems: 'center', marginRight: width * 0.05 
  }
});
